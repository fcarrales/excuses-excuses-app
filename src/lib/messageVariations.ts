...
export const SITUATION_VARIATIONS: Partial<Record<Situation, LangAlts>> = {
  ...
  cancel: {
    english: {
      short: ["Can't make it today. Sorry!", "Need to cancel today — my apologies."],
      natural: [
  ...
  reschedule: {
    english: {
      short: ["Can we move this to another day?", "Rain check? Need to reschedule."],
      natural: [
  ...
  apologize: {
    english: {
      short: ["I'm sorry. That was on me.", "My bad — I apologize."],
      natural: [
  ...
  "dont-want-to-go": {
    english: {
      short: ["Gonna sit this one out.", "Not feeling up to it tonight."],
      natural: [
  ...
  work: {
    english: {
      short: ["Need to handle something at work today.", "Taking time for a work matter."],
      natural: [
  ...
  family: {
    english: {
      short: ["Thinking of you!", "Love you — talk soon."],
      natural: [
  ...
  dating: {
    english: {
      short: ["Had a great time!", "Really enjoyed tonight 😊"],
      natural: [
